...
namespace Imui.Style
{
    ...
    public static class ImStyleSheetBuilderNew
    {
        public static ImPaletteNew BuildPalette(in ImTheme theme)
        {
            var pal = new ImPaletteNew();

            pal.IsDark = theme.Background.GetBrightness() < 0.5f;
            pal.Back = theme.Background;
            pal.Front = theme.Foreground;
            pal.Control = Color.Lerp(pal.IsDark ? theme.Background.ChangeLightness(+15.0f) : theme.Background.ChangeLightness(+5.0f),
                                     theme.Control,
                                     theme.Control.a);
            pal.Control.a = 1.0f;
            pal.Accent = theme.Accent;
            pal.AccentFront = theme.Accent.GetBrightness() > 0.5f ? Color.black : Color.white;
        ...
        private static BuildingContext context;

        public static ImStyleSheet BuildStyleSheet(in ImTheme theme, in ImPaletteNew palette)
        {
            ...
            context.Contrast = theme.Contrast;
            context.BorderContrast = theme.BorderContrast;
            context.IsDark = palette.IsDark;
            ...
            sheet.Button.Normal.BorderColor = palette.Control.ToBorder();

            sheet.Button.Hovered.BackColor = palette.Control.ToHovered();
            sheet.Button.Hovered.FrontColor = palette.Front.ToHovered();
            sheet.Button.Hovered.BorderColor = palette.Control.ToHovered().ToBorder();

            sheet.Button.Pressed.BackColor = palette.Control.ToPressed();
            sheet.Button.Pressed.FrontColor = palette.Front.ToPressed();
            sheet.Button.Pressed.BorderColor = palette.Control.ToPressed().ToBorder();

            // window

            sheet.Window.ContentPadding = theme.Spacing;

            sheet.Window.ResizeHandleNormalColor = palette.Back.ToBorder();
            ...
            sheet.Window.Box.BorderColor = palette.Back.ToBorder().Opaque();

            sheet.Window.TitleBar.BackColor = palette.Back.Ascend().HalfAscend().Opaque();
            ...
            sheet.Window.TitleBar.CloseButton.Hovered.BackColor = palette.Accent.ToHovered();
            sheet.Window.TitleBar.CloseButton.Hovered.FrontColor = palette.AccentFront;
            sheet.Window.TitleBar.CloseButton.Hovered.BorderColor = palette.Accent.ToHovered().ToBorder();

            sheet.Window.TitleBar.CloseButton.Pressed.BackColor = palette.Accent.ToPressed();
            sheet.Window.TitleBar.CloseButton.Pressed.FrontColor = palette.AccentFront.ToPressed();
            sheet.Window.TitleBar.CloseButton.Pressed.BorderColor = palette.Accent.ToPressed().ToBorder();
            ...
            sheet.TextEdit.Normal.Box.BorderColor = palette.Control.ToBorder();
            ...
            sheet.TextEdit.Selected.Box.BackColor = palette.Control.ToHovered();
            ...
            sheet.Scroll.PressedState.BackColor = barBack.ToPressed();
            sheet.Scroll.PressedState.FrontColor = palette.Accent.Ascend().EnsureLightnessDistance(sheet.Scroll.PressedState.BackColor);
            ...
            sheet.Checkbox.Checked.Normal.BorderColor = palette.Accent.ToBorder();

            sheet.Checkbox.Checked.Hovered.BackColor = palette.Accent.ToHovered();
            sheet.Checkbox.Checked.Hovered.FrontColor = palette.AccentFront.ToHovered();
            sheet.Checkbox.Checked.Hovered.BorderColor = palette.Accent.ToHovered().ToBorder();

            sheet.Checkbox.Checked.Pressed.BackColor = palette.Accent.ToPressed();
            sheet.Checkbox.Checked.Pressed.FrontColor = palette.AccentFront.ToPressed();
            sheet.Checkbox.Checked.Pressed.BorderColor = palette.Accent.ToPressed().ToBorder();
            ...
            sheet.Slider.Normal.BorderColor = palette.Control.ToBorder();
            ...
            sheet.Slider.Selected.BackColor = palette.Control.ToPressed();
            ...
            sheet.Slider.Fill.BorderColor = palette.Accent.ToBorder();
            ...
            sheet.Slider.Handle.Normal.BackColor = palette.Control.Ascend();
            sheet.Slider.Handle.Normal.BorderColor = palette.Control.Ascend().ToBorder();
            ...
            sheet.List.Box.BorderColor = palette.Control.ToBorder();
            ...
            sheet.List.ItemSelected.Hovered.BackColor = palette.Accent.ToHovered();
            sheet.List.ItemSelected.Hovered.FrontColor = palette.AccentFront;
            sheet.List.ItemSelected.Hovered.BorderColor = default;

            sheet.List.ItemSelected.Pressed.BackColor = palette.Accent.ToPressed();
            ...
            sheet.Separator.Color = palette.Control.ToBorder().EnsureLightnessDistance(palette.Back);
            ...
            sheet.Tooltip.Box.BorderColor = palette.Back.ToBorder();
            ...
            sheet.Menu.Box.BackColor = palette.Back.Ascend();
            ...
            sheet.MenuBar.Box.BackColor = palette.Back.Ascend();
            ...
            sheet.ColorPicker.BorderColor = palette.Control.ToBorder();
        ...
        private static Color Ascend(this Color color) => color.ChangeLightness(LAYER_DELTA);
        private static Color HalfAscend(this Color color) => color.ChangeLightness(LAYER_DELTA / 2.0f);
        private static Color Descend(this Color color) => color.ChangeLightness(-LAYER_DELTA);
        private static Color ToHovered(this Color color) => color.ChangeLightness(HOVERED_LIGHTNESS_DELTA);
        private static Color ToPressed(this Color color) => color.ChangeLightness(PRESSED_LIGHTNESS_DELTA);
        private static Color Opaque(this Color color) => color.WithAlpha(1.0f);

        private static Color ToBorder(this Color color)
        {
            var delta = context.IsDark ? -BORDER_LIGHTNESS_DELTA : BORDER_LIGHTNESS_DELTA;
            delta *= (context.BorderContrast + 1);
            return color.ChangeLightness(delta);
        }
        ...
        private static Color ChangeLightness(this Color color, float percent)
        {
